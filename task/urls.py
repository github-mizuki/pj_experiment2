...
from .views import (
    ...
    MainTaskUpdateView, SubtaskListView, SubTaskAddView, SubTaskUpdateView, ArchiveListView, archive_view, SubTaskCreateView
)
...
urlpatterns = [
    ...
    path('subtask_add/<int:pk>', SubTaskAddView.as_view(), name='subtask_add'),
    ...
    path('subtask_create/', SubTaskCreateView.as_view(), name='subtask_create'),
